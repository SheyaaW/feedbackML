...
if __name__=="__main__":
    ...
    # parser.add_argument('--video', type=str, help='path of video or video device or http', default=r"C:\Users\tewwa\FeedbackSegment\segmentation_test\leaf_vid_1.mp4", required=False)
